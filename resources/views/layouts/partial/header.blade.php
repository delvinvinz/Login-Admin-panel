<aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between  rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 ">
    <div class="h-19.5">
      ...
      <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="/dashboard">
        ...
        <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Admin Panel Arisan</span>
      </a>
    </div>
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        <li class="mt-0.5 w-full {{ request()->routeIs('dashboard') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors" href="/dashboard">
            <div class="bg-white rounded-lg shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center bg-center stroke-0 text-center xl:p-2.5">
              <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>shop</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">asf
        ...
        <li class="mt-0.5 w-full {{ request()->routeIs('products.index') || request()->is('products*') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
        ...
        <li class="mt-0.5 w-full  {{ request()->routeIs('riwayatpembayaran.index') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/riwayatpembayaran">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Riwayat Pembayaran</span>
          </a>
        </li>

        <li class="mt-0.5 w-full {{ request()->routeIs('riwayatcicilan.index') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/riwayatcicilan">
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Riwayat Cicilan</span>
          </a>
        </li>

        <li class="w-full mt-4">
          <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase opacity-60">Seputar Kue</h6>
        </li>

        <li class="mt-0.5 w-full {{ request()->routeIs('kategori.index') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/kategori">
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Kategori Kue</span>
          </a>
        </li>

        <li class="mt-0.5 w-full {{ request()->routeIs('pengambilankue.index') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/pengambilankue">
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Pengambilan Kue</span>
          </a>
        </li>


        <li class="w-full mt-4">
            <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase opacity-60">Laporan</h6>
          </li>

          <li class="mt-0.5 w-full {{ request()->routeIs('laporanpembayarankue.index') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/laporanpembayarankue">
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Laporan Pembayaran Kue</span>
            </a>
          </li>

          <li class="mt-0.5 w-full {{ request()->routeIs('laporanrekaptransaksi.index') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/laporanrekaptransaksi">
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>spaceship</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Laporan Rekap Transaksi</span>
            </a>
          </li>

          <li class="mt-0.5 w-full {{ request()->routeIs('laporanprofitkue.index') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/laporanprofitkue">
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>spaceship</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Laporan Profit Kue</span>
            </a>
          </li>

          <li class="w-full mt-4">
            <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase opacity-60">User</h6>
          </li>
          <li class="mt-0.5 w-full {{ request()->routeIs('buatuser.index') ? 'bg-[#F5B80F] rounded-lg' : '' }}">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/buatuser">
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>spaceship</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Buat dan Cek Pengguna</span>
            </a>
          </li>
      </ul>
    </div>
