...
<body class="bg-gray-50">
    ...
    <div class="p-5 pb-0 border-b-0 mt-5 border-b-solid text-3xl border-b-transparent">
        <h2 class="font-bold">Edit Daftar Pengambilan</h2>
      </div>
            ...
            <div class="flex-auto px-0 pt-0 pb-2">
                <div class="p-0 overflow-x-auto">
                    ...
                    <div class="mb-5">
                        ...
                        <br>
                        <input type="date" id="nama" value="2024-08-29" class="px-2 border-2 border-gray-200 rounded-lg py-2 w-1/2">
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <br>
                        <input type="text" id="harga" value="Agustono" class="px-2 border-2 border-gray-200 rounded-lg py-2 w-1/2">
                    </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="jenis" value="Kue Nastar" class="px-2 border-2 border-gray-200 rounded-lg py-2 w-1/2">
                        </div>
                        ...
                        <div class="mt-5 mb-5 shadow-lg border-2 border-gray-50 w-1/5 p-5 rounded-lg">
                            ...
                            <div class="">
                                <input class="mt-5" type="radio" checked name="group" id="option1">
                        ...
                        <div>
                            ...
                            <input type="text" id="jumlah" value="200 Kotak" class="px-2 border-2  border-gray-200 rounded-lg py-2 w-1/2">
                        </div>

                        <div class="mt-5">
                            <label for="time" class="text-gray-700 font-bold ">
                                Masukkan Waktu <span class="text-red-500">*</span></label>
                            <input type="time" id="time" value="15:50" name="time" class="mt-1 block w-1/4 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
