...
<body class="bg-gray-50">
    ...
    <div class="mt-5 flex justify-between mx-10">
        <h2 class="font-bold text-3xl ">Tambah User</h2>
            ...
            <div class="flex-auto px-0 pt-0 pb-2">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-5">
                        ...
                        <br>
                        <input type="text" id="nama" class="px-2 border-2 border-gray-200 rounded-lg py-2 w-full" ">
                ...
                <div class="grid grid-cols-2 gap-4">
                      ...
                      <div class="mb-5">
                        ...
                        <br>
                        <input type="text" id="telp" class="px-2 border-2 border-gray-200 rounded-lg py-2 w-full">
                    </div>
                      {{-- Email --}}
                      <div class="mb-5">
                        ...
                        <br>
                        <input type="text" id="email" class="px-2 border-2 border-gray-200 rounded-lg py-2 w-full">
                    </div>
                </div>
                <div class="mb-5">
                    ...
                    <br>
                    <input type="text"  id="password" class="px-2 border-2 border-gray-200 rounded-lg py-2 w-full">
                </div>

                <div class="rounded-lg mb-5">
                    <label class="" for="">Role Pengguna <span class="text-red-500">*</span></label> <br>
                    <div class="">
                    <input class="mt-5" class="bg-[#F5B80F]" type="radio" name="group" id="option1">
